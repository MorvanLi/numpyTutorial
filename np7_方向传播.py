...
class Layer:
    ...
    def __init__(self, n_input, n_neurons, activation=None, weights=None, bias=None):
        """
        :param n_input: input number of nodes
        :param n_neurons: output number of nodes
        ...
        self.weights = weights if weights is not None else rng.normal(-np.sqrt(1 / n_neurons), np.sqrt(1 / n_neurons), (n_input, n_neurons))
        self.bias = bias if bias is not None else rng.normal(0, 1, n_neurons)
